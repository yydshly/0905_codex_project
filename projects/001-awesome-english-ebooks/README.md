...
当前有文件的目录对应经济学人、纽约客、大西洋月刊和连线。[历史 README](https://github.com/hehonghui/awesome-english-ebooks/blob/3fa67a79b45d8f07eb419ab999ac12d20d3f4722/README.md) 还明确列过卫报；Nature 目前只有忽略规则和提交名线索，实际提交文件不足以证明已收录。详见[分层核验记录](./notes/source-processing.md)。

## 已有能力与边界

| 能力 | 已核实的表现 | 边界 |
| --- | --- | --- |
| 外刊归集 | 当前主要目录为经济学人、纽约客、大西洋月刊、连线 | 历史 README 明确列过卫报，当前树没有该目录；Nature 仅有线索 |
